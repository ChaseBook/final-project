...
mlb_career <- mlb_start %>%
  ...
  select(mlb_ID, mlb_end, mlb_length)
...
ggplot(hs_mlb_inactive, aes(signed, war/mlb_length, fill = signed)) +
  geom_boxplot() +
  coord_flip() +
  theme_light() +
  labs(
    x = "Career MLB Wins Above Replacement",
    y = "Signed out of High School?",
    title = "MLB Career Wins Above Replacement of High School Picks to Reach MLB",
    subtitle = "Grouped by whether player signed out of high school"
  )
